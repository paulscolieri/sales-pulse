function getYesterdayCampaignStats() {
  //Utilities.sleep(31000); // 31 seconds cooldown to respect 2 requests/minute
  ...
  if (results.length === 0) {
    Logger.log("No campaign stats found for yesterday.");
